...
{
  description =
    "Nix flake for pythoneda-shared-runtime/lifecycles-events-infrastructure";
  inputs = rec {
    ...
    pythoneda-shared-runtime-lifecycle-events = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-runtime-def/lifecycle-events/0.0.58";
    };
  };
  outputs = inputs:
    with inputs;
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.5";
        sha256 = "1cdm7b529m0jqrnzsc52h1hn0hv4fiddjribkkcpcrsvy2cf6pbs";
        pname = "${org}-${repo}";
        pythonpackage =
          "pythoneda.shared.runtime.events.infrastructure.lifecycle";
        ...
        pythoneda-shared-runtime-lifecycle-events-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure} ${pythoneda-shared-runtime-lifecycle-events}; do
      ...
      in rec {
        ...
        devShells = rec {
          default =pythoneda-shared-runtime-lifecycle-events-infrastructure-python312;
          ...
          pythoneda-shared-runtime-lifecycle-events-infrastructure-python312 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-runtime-lifecycle-events-infrastructure-python312;
          ...
          pythoneda-shared-runtime-lifecycle-events-infrastructure-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-runtime-lifecycle-events-infrastructure-python313;
